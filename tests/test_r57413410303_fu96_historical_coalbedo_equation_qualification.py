...
def test_step3q3_historical_equation_family_is_pinned_but_h_is_fail_closed():
    ...
    assert g["qualification_state"] == "PASS_FAIL_CLOSED_HISTORICAL_EQUATION_FAMILY_QUALIFIED_BAND_SPECIFIC_H_UNRESOLVED"
    ...
    assert p["contract_version"] == "FIRECLOUD_ICE_FU96_RRTMG_BAND_WEIGHTING_PROVENANCE_V1_3"
