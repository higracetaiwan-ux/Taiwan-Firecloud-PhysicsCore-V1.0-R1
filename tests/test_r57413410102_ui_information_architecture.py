...
def test_release_version_is_ui_cleanup_release():
    assert firecloud.__version__ == "1.0.0-R5.7.41.3.4.10.10.2"
...
def test_main_ui_exposes_current_state_without_wall_of_history():
    ...
    assert 'CURRENT_MILESTONE = "Ice Optics Portable WINDY Runtime Decoupling + UI Information Architecture Cleanup"' in src
