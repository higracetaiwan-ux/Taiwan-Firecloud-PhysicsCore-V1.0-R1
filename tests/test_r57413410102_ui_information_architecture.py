...
def test_release_version_matches_current_release():
    assert firecloud.__version__ == "1.0.0-R5.7.41.3.4.10.15.1"
...
def test_main_ui_exposes_current_state_without_wall_of_history():
    ...
    assert 'CURRENT_MILESTONE = "Ice Optics Phase 2 Step 3B — GFS v16 Scheme Pinning + CASE Evidence Handoff Integrity Hotfix"' in src
