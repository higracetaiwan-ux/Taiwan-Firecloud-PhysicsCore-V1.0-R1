...
def test_step3q4_v14_contract_and_current_state_are_accepted_by_integrity_gate():
    ...
    assert contract["contract_version"] == "FIRECLOUD_ICE_FU96_RRTMG_BAND_WEIGHTING_PROVENANCE_V1_20"
    result = {
    ...
    assert "FIRECLOUD_ICE_FU96_RRTMG_BAND_WEIGHTING_PROVENANCE_V1_20" in contract_row["observed"]
