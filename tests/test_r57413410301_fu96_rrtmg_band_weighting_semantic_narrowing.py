...
def test_step3q1_qualifies_semantic_class_but_keeps_exact_history_fail_closed():
    ...
    assert gate["qualification_state"] == "PASS_FAIL_CLOSED_FU96_PRIMARY_BAND_FORWARD_RECONSTRUCTION_INPUTS_QUALIFIED_RRTMG_FINE_GRID_AND_EXACT_BAND24_25_REALIZATION_UNRECOVERED"
