...
def test_phase1_production_handoff_and_case_members_are_explicit():
    ...
    manifest = pd.DataFrame({"artifact": [
        ...
        "v1_gfs_native_nearfield_source_levels.csv", "v1_gfs_native_nearfield_source_summary.csv",
        "v1_ice_cloud_spectral_optics_runtime.csv", "v1_ice_cloud_spectral_optics_summary.csv",
        "v1_windy_ice_optics_summary.csv", "windy_firecloud_ice_optics_summary_v1.json",
        ...
        "v1_formation.csv",
            ...
            "v1_observer_environment_timeline.csv", "v1_observer_environment_timeline_summary.csv",
