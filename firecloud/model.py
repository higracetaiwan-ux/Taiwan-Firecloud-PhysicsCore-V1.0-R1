...
from .ice_microphysics_mapping_candidates import (
    build_global_mapping_candidate_registry as build_ice_microphysics_global_mapping_candidate_registry,
...
from .ice_microphysics_wyser_yang_bulk_contract import (
    build_wyser_yang_bulk_evidence as build_ice_microphysics_wyser_yang_bulk_evidence,
    build_wyser_yang_bulk_gate as build_ice_microphysics_wyser_yang_bulk_gate,
    wyser_yang_bulk_contract_payload as ice_microphysics_wyser_yang_bulk_contract_payload,
)
from .ice_microphysics_wyser_psd_geometry_contract import (
    build_wyser_psd_geometry_evidence as build_ice_microphysics_wyser_psd_geometry_evidence,
    build_wyser_psd_geometry_gate as build_ice_microphysics_wyser_psd_geometry_gate,
    wyser_psd_geometry_contract_payload as ice_microphysics_wyser_psd_geometry_contract_payload,
)
from .ice_microphysics_wyser_mass_geometry_closure import (
    build_wyser_mass_geometry_evidence as build_ice_microphysics_wyser_mass_geometry_evidence,
...
from .ice_microphysics_wyser_yang_coordinate_qualification import (
    build_wyser_yang_coordinate_qualification_evidence as build_ice_microphysics_wyser_yang_coordinate_qualification_evidence,
    build_wyser_yang_coordinate_qualification_gate as build_ice_microphysics_wyser_yang_coordinate_qualification_gate,
    wyser_yang_coordinate_qualification_contract_payload as ice_microphysics_wyser_yang_coordinate_qualification_contract_payload,
)
from .ice_microphysics_wyser_yang_population_bridge import (
    build_wyser_yang_population_bridge_evidence as build_ice_microphysics_wyser_yang_population_bridge_evidence,
...
from .ice_microphysics_fu96_independent_bulk_validation import (
    build_fu96_independent_bulk_validation_evidence as build_ice_microphysics_fu96_independent_bulk_validation_evidence,
...
from .ice_microphysics_yang_matched_geometry_extinction_validation import (
    build_yang_matched_geometry_extinction_validation_evidence as build_ice_microphysics_yang_matched_geometry_extinction_validation_evidence,
    build_yang_matched_geometry_extinction_validation_gate as build_ice_microphysics_yang_matched_geometry_extinction_validation_gate,
    yang_matched_geometry_extinction_validation_contract_payload as ice_microphysics_yang_matched_geometry_extinction_validation_contract_payload,
)
from .ice_microphysics_fu96_rrtmg_ssa_asymmetry_qualification import (
    build_fu96_rrtmg_ssa_asymmetry_qualification_evidence as build_ice_microphysics_fu96_rrtmg_ssa_asymmetry_qualification_evidence,
    build_fu96_rrtmg_ssa_asymmetry_qualification_gate as build_ice_microphysics_fu96_rrtmg_ssa_asymmetry_qualification_gate,
    fu96_rrtmg_ssa_asymmetry_qualification_contract_payload as ice_microphysics_fu96_rrtmg_ssa_asymmetry_qualification_contract_payload,
)
from .ice_microphysics_fu96_rrtmg_ssa_asymmetry_numeric_crosscheck import (
    build_fu96_rrtmg_ssa_asymmetry_numeric_crosscheck_evidence as build_ice_microphysics_fu96_rrtmg_ssa_asymmetry_numeric_crosscheck_evidence,
    build_fu96_rrtmg_ssa_asymmetry_numeric_crosscheck_gate as build_ice_microphysics_fu96_rrtmg_ssa_asymmetry_numeric_crosscheck_gate,
    fu96_rrtmg_ssa_asymmetry_numeric_crosscheck_contract_payload as ice_microphysics_fu96_rrtmg_ssa_asymmetry_numeric_crosscheck_contract_payload,
)
from .ice_microphysics_yang_full_spectral_source_qualification import (
    build_yang_full_spectral_source_qualification_evidence as build_ice_microphysics_yang_full_spectral_source_qualification_evidence,
    build_yang_full_spectral_source_qualification_gate as build_ice_microphysics_yang_full_spectral_source_qualification_gate,
    yang_full_spectral_source_qualification_contract_payload as ice_microphysics_yang_full_spectral_source_qualification_contract_payload,
)
from .ice_microphysics_fu96_rrtmg_band_weighting_provenance import (
    build_fu96_rrtmg_band_weighting_provenance_evidence as build_ice_microphysics_fu96_rrtmg_band_weighting_provenance_evidence,
    build_fu96_rrtmg_band_weighting_provenance_gate as build_ice_microphysics_fu96_rrtmg_band_weighting_provenance_gate,
    fu96_rrtmg_band_weighting_provenance_contract_payload as ice_microphysics_fu96_rrtmg_band_weighting_provenance_contract_payload,
)
...
def analyze_event(lat: float, lon: float, day: date, event: str, tz_name: str | None = None,
    ...
    # R5.7.41.3.4.10.14 Ice Optics Phase 2 Step 3:
    # global-first mapping candidate intake + scheme-contract qualification.
    # No mapping equation is executed and no production promotion is permitted.
    _ice_mapping_candidate_t0 = perf_counter()
    v1_ice_microphysics_global_mapping_candidate_registry = build_ice_microphysics_global_mapping_candidate_registry()
    v1_ice_microphysics_global_mapping_qualification_gate = build_ice_microphysics_global_mapping_qualification_gate(
        v1_ice_microphysics_global_mapping_candidate_registry
    )
    ice_microphysics_global_mapping_candidate_contract = ice_microphysics_global_mapping_candidate_contract_payload(
        physicscore_version=PHYSICSCORE_VERSION
    )
    _mapping_candidate_state = (
        str(v1_ice_microphysics_global_mapping_qualification_gate.iloc[0].get("qualification_state", "UNKNOWN"))
        if not v1_ice_microphysics_global_mapping_qualification_gate.empty else "UNKNOWN"
    )
    performance_rows.append({
        "stage": "ICE_MICROPHYSICS_GLOBAL_MAPPING_CANDIDATE_QUALIFICATION",
        "elapsed_seconds": max(0.0, perf_counter() - _ice_mapping_candidate_t0),
        "cache_status": "STATIC_GLOBAL_CANDIDATE_INTAKE_NO_NETWORK_NO_PHYSICS_PROMOTION",
        "detail": (
            f"candidates={len(v1_ice_microphysics_global_mapping_candidate_registry)};"
            f"state={_mapping_candidate_state};"
            "GLOBAL_FIRST;GFSV16_PRIMARY;NO_SCHEME_VERSION_SUBSTITUTION;NO_DMAX_PROMOTION"
        ),
    })
    ...
    # R5.7.41.3.4.10.17 Ice Optics Phase 2 Step 3D:
    # qualify the Wyser mixed PSD + Yang/Bi habit/roughness bulk-integration
    # contract without reconstructing a runtime PSD or synthesizing Ice tau.
    _ice_wyser_yang_bulk_t0 = perf_counter()
    v1_ice_microphysics_wyser_yang_bulk_evidence = build_ice_microphysics_wyser_yang_bulk_evidence()
    v1_ice_microphysics_wyser_yang_bulk_gate = build_ice_microphysics_wyser_yang_bulk_gate(
        v1_ice_microphysics_wyser_yang_bulk_evidence
    )
    ice_microphysics_wyser_yang_bulk_contract = ice_microphysics_wyser_yang_bulk_contract_payload(
        physicscore_version=PHYSICSCORE_VERSION
    )
    _ice_wyser_yang_bulk_state = (
        str(v1_ice_microphysics_wyser_yang_bulk_gate.iloc[0].get("qualification_state", "UNKNOWN"))
        if not v1_ice_microphysics_wyser_yang_bulk_gate.empty else "UNKNOWN"
    )
    performance_rows.append({
        "stage": "ICE_MICROPHYSICS_WYSER_YANG_BULK_INTEGRATION_QUALIFICATION",
        "elapsed_seconds": max(0.0, perf_counter() - _ice_wyser_yang_bulk_t0),
        "cache_status": "STATIC_BULK_CONTRACT_EVIDENCE_NO_NETWORK_NO_PHYSICS_PROMOTION",
        "detail": (
            f"evidence_rows={len(v1_ice_microphysics_wyser_yang_bulk_evidence)};"
            f"state={_ice_wyser_yang_bulk_state};"
            "WYSER_PSD_CORE=PARTIALLY_PINNED;YANG_SOLID_COLUMN=CANDIDATE_ONLY;BULK_INTEGRATION=NOT_ELIGIBLE"
        ),
    })


    # R5.7.41.3.4.10.18 Ice Optics Phase 2 Step 3E:
    # pin the primary-source IWC amplitude-normalization rule while keeping
    # numeric PSD reconstruction, exact geometry and L->Dmax fail-closed.
    _ice_wyser_psd_geometry_t0 = perf_counter()
    v1_ice_microphysics_wyser_psd_geometry_evidence = build_ice_microphysics_wyser_psd_geometry_evidence()
    v1_ice_microphysics_wyser_psd_geometry_gate = build_ice_microphysics_wyser_psd_geometry_gate(
        v1_ice_microphysics_wyser_psd_geometry_evidence
    )
    ice_microphysics_wyser_psd_geometry_contract = ice_microphysics_wyser_psd_geometry_contract_payload(
        physicscore_version=PHYSICSCORE_VERSION
    )
    _ice_wyser_psd_geometry_state = (
        str(v1_ice_microphysics_wyser_psd_geometry_gate.iloc[0].get("qualification_state", "UNKNOWN"))
        if not v1_ice_microphysics_wyser_psd_geometry_gate.empty else "UNKNOWN"
    )
    performance_rows.append({
        "stage": "ICE_MICROPHYSICS_WYSER_PSD_NORMALIZATION_GEOMETRY_QUALIFICATION",
        "elapsed_seconds": max(0.0, perf_counter() - _ice_wyser_psd_geometry_t0),
        "cache_status": "STATIC_NORMALIZATION_GEOMETRY_EVIDENCE_NO_NETWORK_NO_PHYSICS_PROMOTION",
        "detail": (
            f"evidence_rows={len(v1_ice_microphysics_wyser_psd_geometry_evidence)};"
            f"state={_ice_wyser_psd_geometry_state};"
            "NORMALIZATION_RULE=PINNED;ABSOLUTE_PSD_EXECUTION=BLOCKED;L_TO_DMAX=BLOCKED"
        ),
    })

    # R5.7.41.3.4.10.19 Ice Optics Phase 2 Step 3F:
    # record corroborated Wyser/Wyser-Yang geometry lineage while keeping exact
    # primary Eq.5/Eq.6 numerics, absolute PSD execution and mass closure blocked.
    _ice_wyser_mass_geometry_t0 = perf_counter()
    v1_ice_microphysics_wyser_mass_geometry_evidence = build_ice_microphysics_wyser_mass_geometry_evidence()
    v1_ice_microphysics_wyser_mass_geometry_gate = build_ice_microphysics_wyser_mass_geometry_gate(
        v1_ice_microphysics_wyser_mass_geometry_evidence
    )
    ice_microphysics_wyser_mass_geometry_contract = ice_microphysics_wyser_mass_geometry_contract_payload(
        physicscore_version=PHYSICSCORE_VERSION
    )
    _ice_wyser_mass_geometry_state = (
        str(v1_ice_microphysics_wyser_mass_geometry_gate.iloc[0].get("qualification_state", "UNKNOWN"))
        if not v1_ice_microphysics_wyser_mass_geometry_gate.empty else "UNKNOWN"
    )
    performance_rows.append({
        "stage": "ICE_MICROPHYSICS_WYSER_EQ5_EQ6_MASS_GEOMETRY_CLOSURE_QUALIFICATION",
        "elapsed_seconds": max(0.0, perf_counter() - _ice_wyser_mass_geometry_t0),
        "cache_status": "STATIC_MASS_GEOMETRY_EVIDENCE_NO_NETWORK_NO_PHYSICS_PROMOTION",
        "detail": (
            f"evidence_rows={len(v1_ice_microphysics_wyser_mass_geometry_evidence)};"
            f"state={_ice_wyser_mass_geometry_state};"
            "EQ5_LINEAGE=CORROBORATED;EQ5_PRIMARY=BLOCKED;EQ6_PRIMARY=BLOCKED;MASS_CLOSURE=BLOCKED"
        ),
    })
    ...
    # R5.7.41.3.4.10.21 Ice Optics Phase 2 Step 3H:
    # maximum-dimension coordinate qualification only; shape/optics remain fail-closed.
    _ice_wyser_yang_coordinate_t0 = perf_counter()
    v1_ice_microphysics_wyser_yang_coordinate_qualification_evidence = build_ice_microphysics_wyser_yang_coordinate_qualification_evidence()
    v1_ice_microphysics_wyser_yang_coordinate_qualification_gate = build_ice_microphysics_wyser_yang_coordinate_qualification_gate(
        v1_ice_microphysics_wyser_yang_coordinate_qualification_evidence
    )
    ice_microphysics_wyser_yang_coordinate_qualification_contract = ice_microphysics_wyser_yang_coordinate_qualification_contract_payload(
        physicscore_version=PHYSICSCORE_VERSION
    )
    _ice_wyser_yang_coordinate_state = (
        str(v1_ice_microphysics_wyser_yang_coordinate_qualification_gate.iloc[0].get("qualification_state", "UNKNOWN"))
        if not v1_ice_microphysics_wyser_yang_coordinate_qualification_gate.empty else "UNKNOWN"
    )
    performance_rows.append({
        "stage": "ICE_MICROPHYSICS_WYSER_YANG_COORDINATE_QUALIFICATION_AUDIT",
        "elapsed_seconds": max(0.0, perf_counter() - _ice_wyser_yang_coordinate_t0),
        "cache_status": "STATIC_COORDINATE_QUALIFICATION_NO_NETWORK_NO_PHYSICS_PROMOTION",
        "detail": (
            f"evidence_rows={len(v1_ice_microphysics_wyser_yang_coordinate_qualification_evidence)};"
            f"state={_ice_wyser_yang_coordinate_state};"
            "COORDINATE=VALIDATED;SHAPE=BLOCKED;HABIT=BLOCKED;ROUGHNESS=BLOCKED;BULK_OPTICS=BLOCKED"
        ),
    })

    # R5.7.41.3.4.10.22 Ice Optics Phase 2 Step 3I:
    # diagnostic Wyser population + Yang/Bi optical-kernel bridge; no bulk/production promotion.
    _ice_wyser_yang_population_t0 = perf_counter()
    v1_ice_microphysics_wyser_yang_population_bridge_evidence = build_ice_microphysics_wyser_yang_population_bridge_evidence()
    v1_ice_microphysics_wyser_yang_population_bridge_gate = build_ice_microphysics_wyser_yang_population_bridge_gate(
        v1_ice_microphysics_wyser_yang_population_bridge_evidence
    )
    ice_microphysics_wyser_yang_population_bridge_contract = ice_microphysics_wyser_yang_population_bridge_contract_payload(
        physicscore_version=PHYSICSCORE_VERSION
    )
    _ice_wyser_yang_population_state = (
        str(v1_ice_microphysics_wyser_yang_population_bridge_gate.iloc[0].get("qualification_state", "UNKNOWN"))
        if not v1_ice_microphysics_wyser_yang_population_bridge_gate.empty else "UNKNOWN"
    )
    performance_rows.append({
        "stage": "ICE_MICROPHYSICS_WYSER_YANG_POPULATION_BRIDGE_AUDIT",
        "elapsed_seconds": max(0.0, perf_counter() - _ice_wyser_yang_population_t0),
        "cache_status": "STATIC_DIAGNOSTIC_POPULATION_KERNEL_BRIDGE_NO_PHYSICS_PROMOTION",
        "detail": (
            f"evidence_rows={len(v1_ice_microphysics_wyser_yang_population_bridge_evidence)};"
            f"state={_ice_wyser_yang_population_state};"
            "CEXT_KERNEL=PASS_DIAGNOSTIC;DUAL_MASS=SEPARATED;BULK_OPTICS=BLOCKED;PRODUCTION=BLOCKED"
        ),
    })
    ...
    # R5.7.41.3.4.10.24 Ice Optics Phase 2 Step 3K:
    # Fu (1996) projected-area geometric-optics independent bulk cross-check; no tau/production promotion.
    _ice_fu96_independent_bulk_t0 = perf_counter()
    v1_ice_microphysics_fu96_independent_bulk_validation_evidence = build_ice_microphysics_fu96_independent_bulk_validation_evidence()
    v1_ice_microphysics_fu96_independent_bulk_validation_gate = build_ice_microphysics_fu96_independent_bulk_validation_gate(
        v1_ice_microphysics_fu96_independent_bulk_validation_evidence
    )
    ice_microphysics_fu96_independent_bulk_validation_contract = ice_microphysics_fu96_independent_bulk_validation_contract_payload(
        physicscore_version=PHYSICSCORE_VERSION
    )
    _ice_fu96_independent_bulk_state = (
        str(v1_ice_microphysics_fu96_independent_bulk_validation_gate.iloc[0].get("qualification_state", "UNKNOWN"))
        if not v1_ice_microphysics_fu96_independent_bulk_validation_gate.empty else "UNKNOWN"
    )
    performance_rows.append({
        "stage": "ICE_MICROPHYSICS_FU96_INDEPENDENT_BULK_VALIDATION_AUDIT",
        "elapsed_seconds": max(0.0, perf_counter() - _ice_fu96_independent_bulk_t0),
        "cache_status": "STATIC_FU96_INDEPENDENT_OPTICAL_CROSSCHECK_NO_TAU_NO_PHYSICS_PROMOTION",
        "detail": (
            f"evidence_rows={len(v1_ice_microphysics_fu96_independent_bulk_validation_evidence)};"
            f"state={_ice_fu96_independent_bulk_state};"
            "FU96_CROSSCHECK=EXECUTED;SCIENTIFIC_VALIDATION=BLOCKED;TAU=BLOCKED;PRODUCTION=BLOCKED"
        ),
    })
    ...
    # R5.7.41.3.4.10.26 Ice Optics Phase 2 Step 3M:
    # Yang/Bi matched-geometry Fu96 extinction validation; extinction-only, fail-closed.
    _ice_yang_matched_ext_t0 = perf_counter()
    v1_ice_microphysics_yang_matched_geometry_extinction_validation_evidence = build_ice_microphysics_yang_matched_geometry_extinction_validation_evidence()
    v1_ice_microphysics_yang_matched_geometry_extinction_validation_gate = build_ice_microphysics_yang_matched_geometry_extinction_validation_gate(
        v1_ice_microphysics_yang_matched_geometry_extinction_validation_evidence
    )
    ice_microphysics_yang_matched_geometry_extinction_validation_contract = ice_microphysics_yang_matched_geometry_extinction_validation_contract_payload(
        physicscore_version=PHYSICSCORE_VERSION
    )
    _ice_yang_matched_ext_state = (
        str(v1_ice_microphysics_yang_matched_geometry_extinction_validation_gate.iloc[0].get("qualification_state", "UNKNOWN"))
        if not v1_ice_microphysics_yang_matched_geometry_extinction_validation_gate.empty else "UNKNOWN"
    )
    performance_rows.append({
        "stage": "ICE_MICROPHYSICS_YANG_MATCHED_GEOMETRY_EXTINCTION_VALIDATION_AUDIT",
        "elapsed_seconds": max(0.0, perf_counter() - _ice_yang_matched_ext_t0),
        "cache_status": "STATIC_MATCHED_GEOMETRY_EXTINCTION_REFERENCE_SSA_G_TAU_PRODUCTION_BLOCKED",
        "detail": (
            f"evidence_rows={len(v1_ice_microphysics_yang_matched_geometry_extinction_validation_evidence)};"
            f"state={_ice_yang_matched_ext_state};"
            "EXTINCTION_REFERENCE=READY;SSA_G=BLOCKED;FULL_OPTICS=BLOCKED;TAU=BLOCKED;PRODUCTION=BLOCKED"
        ),
    })

    # R5.7.41.3.4.10.27 Ice Optics Phase 2 Step 3N:
    # Fu96/RRTMG independent bulk-band SSA/g source qualification; exact six-band validation remains blocked.
    _ice_fu96_rrtmg_ssag_t0 = perf_counter()
    v1_ice_microphysics_fu96_rrtmg_ssa_asymmetry_qualification_evidence = build_ice_microphysics_fu96_rrtmg_ssa_asymmetry_qualification_evidence()
    v1_ice_microphysics_fu96_rrtmg_ssa_asymmetry_qualification_gate = build_ice_microphysics_fu96_rrtmg_ssa_asymmetry_qualification_gate(
        v1_ice_microphysics_fu96_rrtmg_ssa_asymmetry_qualification_evidence
    )
    ice_microphysics_fu96_rrtmg_ssa_asymmetry_qualification_contract = ice_microphysics_fu96_rrtmg_ssa_asymmetry_qualification_contract_payload(
        physicscore_version=PHYSICSCORE_VERSION
    )
    _ice_fu96_rrtmg_ssag_state = (
        str(v1_ice_microphysics_fu96_rrtmg_ssa_asymmetry_qualification_gate.iloc[0].get("qualification_state", "UNKNOWN"))
        if not v1_ice_microphysics_fu96_rrtmg_ssa_asymmetry_qualification_gate.empty else "UNKNOWN"
    )
    performance_rows.append({
        "stage": "ICE_MICROPHYSICS_FU96_RRTMG_SSA_ASYMMETRY_QUALIFICATION_AUDIT",
        "elapsed_seconds": max(0.0, perf_counter() - _ice_fu96_rrtmg_ssag_t0),
        "cache_status": "STATIC_FU96_RRTMG_BULK_BAND_REFERENCE_EXACT_SIX_BAND_AND_PRODUCTION_BLOCKED",
        "detail": (
            f"evidence_rows={len(v1_ice_microphysics_fu96_rrtmg_ssa_asymmetry_qualification_evidence)};"
            f"state={_ice_fu96_rrtmg_ssag_state};"
            "BULK_BAND_SSA_G_REFERENCE=PINNED;EXACT_SIX_BAND=BLOCKED;TAU=BLOCKED;PRODUCTION=BLOCKED"
        ),
    })

    # R5.7.41.3.4.10.28 Ice Optics Phase 2 Step 3O:
    # Fu96/RRTMG broad-band SSA/g numeric cross-check; exact spectral validation remains blocked.
    _ice_fu96_rrtmg_numeric_t0 = perf_counter()
    v1_ice_microphysics_fu96_rrtmg_ssa_asymmetry_numeric_crosscheck_evidence = build_ice_microphysics_fu96_rrtmg_ssa_asymmetry_numeric_crosscheck_evidence()
    v1_ice_microphysics_fu96_rrtmg_ssa_asymmetry_numeric_crosscheck_gate = build_ice_microphysics_fu96_rrtmg_ssa_asymmetry_numeric_crosscheck_gate(
        v1_ice_microphysics_fu96_rrtmg_ssa_asymmetry_numeric_crosscheck_evidence
    )
    ice_microphysics_fu96_rrtmg_ssa_asymmetry_numeric_crosscheck_contract = ice_microphysics_fu96_rrtmg_ssa_asymmetry_numeric_crosscheck_contract_payload(
        physicscore_version=PHYSICSCORE_VERSION
    )
    _ice_fu96_rrtmg_numeric_state = (
        str(v1_ice_microphysics_fu96_rrtmg_ssa_asymmetry_numeric_crosscheck_gate.iloc[0].get("qualification_state", "UNKNOWN"))
        if not v1_ice_microphysics_fu96_rrtmg_ssa_asymmetry_numeric_crosscheck_gate.empty else "UNKNOWN"
    )
    performance_rows.append({
        "stage": "ICE_MICROPHYSICS_FU96_RRTMG_SSA_ASYMMETRY_NUMERIC_CROSSCHECK_AUDIT",
        "elapsed_seconds": max(0.0, perf_counter() - _ice_fu96_rrtmg_numeric_t0),
        "cache_status": "STATIC_BROAD_BAND_NUMERIC_CROSSCHECK_EXACT_SPECTRAL_AND_PRODUCTION_BLOCKED",
        "detail": (
            f"evidence_rows={len(v1_ice_microphysics_fu96_rrtmg_ssa_asymmetry_numeric_crosscheck_evidence)};"
            f"state={_ice_fu96_rrtmg_numeric_state};"
            "NUMERIC_CROSSCHECK=EXECUTED;EXACT_SPECTRAL_VALIDATION=BLOCKED;TAU=BLOCKED;PRODUCTION=BLOCKED"
        ),
    })

    # R5.7.41.3.4.10.29 Ice Optics Phase 2 Step 3P:
    # authoritative Yang/Bi full-spectral source capability qualification.
    _ice_yang_full_spectral_t0 = perf_counter()
    v1_ice_microphysics_yang_full_spectral_source_qualification_evidence = build_ice_microphysics_yang_full_spectral_source_qualification_evidence()
    v1_ice_microphysics_yang_full_spectral_source_qualification_gate = build_ice_microphysics_yang_full_spectral_source_qualification_gate(
        v1_ice_microphysics_yang_full_spectral_source_qualification_evidence
    )
    ice_microphysics_yang_full_spectral_source_qualification_contract = ice_microphysics_yang_full_spectral_source_qualification_contract_payload(
        evidence=v1_ice_microphysics_yang_full_spectral_source_qualification_evidence,
        gate=v1_ice_microphysics_yang_full_spectral_source_qualification_gate,
        physicscore_version=PHYSICSCORE_VERSION,
    )
    _ice_yang_full_spectral_state = (
        str(v1_ice_microphysics_yang_full_spectral_source_qualification_gate.iloc[0].get("qualification_state", "UNKNOWN"))
        if not v1_ice_microphysics_yang_full_spectral_source_qualification_gate.empty else "UNKNOWN"
    )
    performance_rows.append({
        "stage": "ICE_MICROPHYSICS_YANG_FULL_SPECTRAL_SOURCE_QUALIFICATION_AUDIT",
        "elapsed_seconds": max(0.0, perf_counter() - _ice_yang_full_spectral_t0),
        "cache_status": "STATIC_SOURCE_CAPABILITY_EXACT_WEIGHTING_AND_PRODUCTION_BLOCKED",
        "detail": (
            f"evidence_rows={len(v1_ice_microphysics_yang_full_spectral_source_qualification_evidence)};"
            f"state={_ice_yang_full_spectral_state};"
            "SOURCE_CAPABILITY=QUALIFIED_FAIL_CLOSED;EXACT_WEIGHTING=BLOCKED;TAU=BLOCKED;PRODUCTION=BLOCKED"
        ),
    })

    # R5.7.41.3.4.10.30 Ice Optics Phase 2 Step 3Q:
    # exact Fu96/RRTMG band-weighting provenance qualification.
    _ice_fu96_weighting_t0 = perf_counter()
    v1_ice_microphysics_fu96_rrtmg_band_weighting_provenance_evidence = build_ice_microphysics_fu96_rrtmg_band_weighting_provenance_evidence()
    v1_ice_microphysics_fu96_rrtmg_band_weighting_provenance_gate = build_ice_microphysics_fu96_rrtmg_band_weighting_provenance_gate(
        v1_ice_microphysics_fu96_rrtmg_band_weighting_provenance_evidence
    )
    ice_microphysics_fu96_rrtmg_band_weighting_provenance_contract = ice_microphysics_fu96_rrtmg_band_weighting_provenance_contract_payload(
        evidence=v1_ice_microphysics_fu96_rrtmg_band_weighting_provenance_evidence,
        gate=v1_ice_microphysics_fu96_rrtmg_band_weighting_provenance_gate,
        physicscore_version=PHYSICSCORE_VERSION,
    )
    _ice_fu96_weighting_state = (
        str(v1_ice_microphysics_fu96_rrtmg_band_weighting_provenance_gate.iloc[0].get("qualification_state", "UNKNOWN"))
        if not v1_ice_microphysics_fu96_rrtmg_band_weighting_provenance_gate.empty else "UNKNOWN"
    )
    performance_rows.append({
        "stage": "ICE_MICROPHYSICS_FU96_RRTMG_BAND_WEIGHTING_PROVENANCE_AUDIT",
        "elapsed_seconds": max(0.0, perf_counter() - _ice_fu96_weighting_t0),
        "cache_status": "STATIC_PROVENANCE_EXACT_WEIGHTING_AND_PRODUCTION_BLOCKED",
        "detail": (
            f"evidence_rows={len(v1_ice_microphysics_fu96_rrtmg_band_weighting_provenance_evidence)};"
            f"state={_ice_fu96_weighting_state};"
            "EXACT_WEIGHTING=BLOCKED;LIKE_FOR_LIKE=BLOCKED;TAU=BLOCKED;PRODUCTION=BLOCKED"
        ),
    })
    ...
    _pre_integrity_result = {
        ...
        "v1_ice_microphysics_wyser_yang_bulk_evidence": v1_ice_microphysics_wyser_yang_bulk_evidence,
        "v1_ice_microphysics_wyser_yang_bulk_gate": v1_ice_microphysics_wyser_yang_bulk_gate,
        "ice_microphysics_wyser_yang_bulk_contract": ice_microphysics_wyser_yang_bulk_contract,
        "ice_microphysics_wyser_yang_bulk_required": True,
        "v1_ice_microphysics_wyser_psd_geometry_evidence": v1_ice_microphysics_wyser_psd_geometry_evidence,
        "v1_ice_microphysics_wyser_psd_geometry_gate": v1_ice_microphysics_wyser_psd_geometry_gate,
        "ice_microphysics_wyser_psd_geometry_contract": ice_microphysics_wyser_psd_geometry_contract,
        ...
        "v1_ice_microphysics_wyser_yang_coordinate_qualification_evidence": v1_ice_microphysics_wyser_yang_coordinate_qualification_evidence,
        "v1_ice_microphysics_wyser_yang_coordinate_qualification_gate": v1_ice_microphysics_wyser_yang_coordinate_qualification_gate,
        "ice_microphysics_wyser_yang_coordinate_qualification_contract": ice_microphysics_wyser_yang_coordinate_qualification_contract,
        ...
        "v1_ice_microphysics_fu96_independent_bulk_validation_evidence": v1_ice_microphysics_fu96_independent_bulk_validation_evidence,
        ...
        "v1_ice_microphysics_yang_matched_geometry_extinction_validation_evidence": v1_ice_microphysics_yang_matched_geometry_extinction_validation_evidence,
        "v1_ice_microphysics_yang_matched_geometry_extinction_validation_gate": v1_ice_microphysics_yang_matched_geometry_extinction_validation_gate,
        "ice_microphysics_yang_matched_geometry_extinction_validation_contract": ice_microphysics_yang_matched_geometry_extinction_validation_contract,
        "ice_microphysics_yang_matched_geometry_extinction_validation_required": True,
        "v1_ice_microphysics_fu96_rrtmg_ssa_asymmetry_qualification_evidence": v1_ice_microphysics_fu96_rrtmg_ssa_asymmetry_qualification_evidence,
        "v1_ice_microphysics_fu96_rrtmg_ssa_asymmetry_qualification_gate": v1_ice_microphysics_fu96_rrtmg_ssa_asymmetry_qualification_gate,
        "ice_microphysics_fu96_rrtmg_ssa_asymmetry_qualification_contract": ice_microphysics_fu96_rrtmg_ssa_asymmetry_qualification_contract,
        "ice_microphysics_fu96_rrtmg_ssa_asymmetry_qualification_required": True,
        "v1_ice_microphysics_fu96_rrtmg_ssa_asymmetry_numeric_crosscheck_evidence": v1_ice_microphysics_fu96_rrtmg_ssa_asymmetry_numeric_crosscheck_evidence,
        "v1_ice_microphysics_fu96_rrtmg_ssa_asymmetry_numeric_crosscheck_gate": v1_ice_microphysics_fu96_rrtmg_ssa_asymmetry_numeric_crosscheck_gate,
        "ice_microphysics_fu96_rrtmg_ssa_asymmetry_numeric_crosscheck_contract": ice_microphysics_fu96_rrtmg_ssa_asymmetry_numeric_crosscheck_contract,
        "ice_microphysics_fu96_rrtmg_ssa_asymmetry_numeric_crosscheck_required": True,
        "v1_ice_microphysics_yang_full_spectral_source_qualification_evidence": v1_ice_microphysics_yang_full_spectral_source_qualification_evidence,
        "v1_ice_microphysics_yang_full_spectral_source_qualification_gate": v1_ice_microphysics_yang_full_spectral_source_qualification_gate,
        "ice_microphysics_yang_full_spectral_source_qualification_contract": ice_microphysics_yang_full_spectral_source_qualification_contract,
        "ice_microphysics_yang_full_spectral_source_qualification_required": True,
        "v1_ice_microphysics_fu96_rrtmg_band_weighting_provenance_evidence": v1_ice_microphysics_fu96_rrtmg_band_weighting_provenance_evidence,
        "v1_ice_microphysics_fu96_rrtmg_band_weighting_provenance_gate": v1_ice_microphysics_fu96_rrtmg_band_weighting_provenance_gate,
        "ice_microphysics_fu96_rrtmg_band_weighting_provenance_contract": ice_microphysics_fu96_rrtmg_band_weighting_provenance_contract,
