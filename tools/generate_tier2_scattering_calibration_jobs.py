...
from firecloud.tier2_scattering_calibration import build_calibration_jobs

p=argparse.ArgumentParser(description="Generate explicit external-RT jobs for the Taiwan Firecloud Tier-2 scattering calibration grid.")
...
df=build_calibration_jobs(spec, solver_family=a.solver_family)
