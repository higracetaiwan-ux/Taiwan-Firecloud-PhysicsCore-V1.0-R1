...
**Current checkpoint: V1.0-R4.5.1 — Native Condensate Schema Bridge Fix.**
...
See `RELEASE_NOTES_PhysicsCore_V1.0-R4.5.1.md` and `IMPLEMENTATION_STATUS_PhysicsCore_V1.0-R4.5.1.md`.
