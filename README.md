...
R4.9 separates exact target-cloud COT, bounded adjacent-native optical hypotheses, and direct Cloud-Fraction/native-condensate conflicts. It never converts Cloud Fraction or RH into COT. CASE exports now include `v1_target_canvas_optical_evidence.csv` and `v1_target_canvas_optical_summary.csv`.
