...
**Current checkpoint: V1.0-R1 — Contracts + CloudScene + finite-solar-disk geometry foundation.**
...
See `RELEASE_NOTES_PhysicsCore_V1.0-R1.md` for the exact implemented boundary.
...
- `RELEASE_NOTES_PhysicsCore_V1.0-R1.md` — current R1 release notes.
