...
**Current checkpoint: V1.0-R4.7 — Six-band Formation Prerequisite Integration.**

R4.7 makes the remaining Formation prerequisites explicit and auditable: six-band gas spectroscopy readiness, precipitation-path optical evidence, and target Canvas optical readiness. Missing 550 nm spectroscopy and unresolved precipitation optics remain fail-closed; no interpolation or surface-rain-to-optical-depth conversion is permitted.
...
See `RELEASE_NOTES_PhysicsCore_V1.0-R4.7.md` and `IMPLEMENTATION_STATUS_PhysicsCore_V1.0-R4.7.md`.
