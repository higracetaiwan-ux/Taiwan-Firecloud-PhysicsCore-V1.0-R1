...
if run or st.session_state.analysis_result is not None:
    ...
    def _build_case_archive_bytes():
        ...
        _case_gfsv16_rei_dmax_bridge_evidence = build_gfsv16_rei_dmax_bridge_evidence()
        _case_gfsv16_rei_dmax_bridge_gate = build_gfsv16_rei_dmax_bridge_gate(
            _case_gfsv16_rei_dmax_bridge_evidence
        )
        ...
        _case_wyser_psd_geometry_evidence = build_wyser_psd_geometry_evidence()
        _case_wyser_psd_geometry_gate = build_wyser_psd_geometry_gate(
            _case_wyser_psd_geometry_evidence
        )
        _case_wyser_psd_geometry_contract = wyser_psd_geometry_contract_payload(
            physicscore_version=__version__
        )
        _case_wyser_mass_geometry_evidence = build_wyser_mass_geometry_evidence()
        _case_wyser_mass_geometry_gate = build_wyser_mass_geometry_gate(
            _case_wyser_mass_geometry_evidence
        )
        ...
        _case_wyser_yang_coordinate_qualification_evidence = build_wyser_yang_coordinate_qualification_evidence()
        _case_wyser_yang_coordinate_qualification_gate = build_wyser_yang_coordinate_qualification_gate(
            _case_wyser_yang_coordinate_qualification_evidence
        )
        ...
        _case_wyser_yang_diagnostic_bulk_evidence = build_wyser_yang_diagnostic_bulk_evidence()
        _case_wyser_yang_diagnostic_bulk_gate = build_wyser_yang_diagnostic_bulk_gate(
            _case_wyser_yang_diagnostic_bulk_evidence
        )
        ...
        _case_yang_habit_roughness_qualification_evidence = build_yang_habit_roughness_qualification_evidence()
        _case_yang_habit_roughness_qualification_gate = build_yang_habit_roughness_qualification_gate(
            _case_yang_habit_roughness_qualification_evidence
        )
        ...
        _case_fu96_rrtmg_ssa_asymmetry_qualification_evidence = build_fu96_rrtmg_ssa_asymmetry_qualification_evidence()
        _case_fu96_rrtmg_ssa_asymmetry_qualification_gate = build_fu96_rrtmg_ssa_asymmetry_qualification_gate(
            _case_fu96_rrtmg_ssa_asymmetry_qualification_evidence
        )
        _case_fu96_rrtmg_ssa_asymmetry_qualification_contract = fu96_rrtmg_ssa_asymmetry_qualification_contract_payload(
            physicscore_version=__version__
        )
        _case_fu96_rrtmg_ssa_asymmetry_numeric_crosscheck_evidence = build_fu96_rrtmg_ssa_asymmetry_numeric_crosscheck_evidence()
        _case_fu96_rrtmg_ssa_asymmetry_numeric_crosscheck_gate = build_fu96_rrtmg_ssa_asymmetry_numeric_crosscheck_gate(
            _case_fu96_rrtmg_ssa_asymmetry_numeric_crosscheck_evidence
        )
        ...
        _items = [
            ...
            ("ice_microphysics_wyser_psd_geometry_evidence.csv", _case_wyser_psd_geometry_evidence),
            ...
            ("ice_microphysics_fu96_rrtmg_ssa_asymmetry_qualification_evidence.csv", _case_fu96_rrtmg_ssa_asymmetry_qualification_evidence),
