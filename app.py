...
st.divider()
st.caption(
    "R5.7.32 修正 CAMS geopotential 單位正規化：ecCodes 的 m**2 s**-2 必須除以 g0 轉為 geopotential height metres；未知單位 fail-close，並新增 60/80/100 km Glow observer aerosol coverage Integrity。R5.7.31 兩段六波段 extinction 契約維持不變。"
