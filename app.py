...
if run or st.session_state.analysis_result is not None:
    ...
    st.subheader("PhysicsCore V1.0-R3.2：CloudScene × Canvas-specific Ray × Six-band Optical Path")
    ...
    if st.session_state.case_archive_bytes is not None:
        st.download_button(
            ...
            file_name=f"Taiwan-Firecloud-PhysicsCore-V1.0-R3.2_{archive_day}_{archive_event}_CASE.zip",
